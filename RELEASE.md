...
- Capacity database reads no longer block concurrent app and job API requests, and targeted MongoDB indexes improve authentication lookups, counts, filtering, and pagination on larger installations.
