...
📊 **Capacity dashboard improved** — no more hangs. It now pre-warms on startup, shows real remaining resources, auto-refreshes while open, and stays responsive even if updates fail.
