...
async def update_user(user_data: Annotated[models.UserUpdate, Depends(models.UserUpdate.update_admin_form)], username: str, current_user: Annotated[models.User, Depends(auth.check_roles(["admin"]))]):
